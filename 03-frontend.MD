...
[OPTIONAL] Delete whole content in file:
```
:%d
```
...
less access.log
```
shift+g -> Goto botom logs

```
less /var/log/messages
```
If any service or components is not working means check latest logs in Frontend Component
```
cd /var/log/nginx/
tail -f error.log
```
